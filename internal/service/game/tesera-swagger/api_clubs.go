...
/*
ClubsApiService List of clubs
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ClubsApiGetOpts - Optional Parameters:
...
func (a *ClubsApiService) Get(ctx context.Context, localVarOptionals *ClubsApiGetOpts) ([]ClubInfo, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []ClubInfo
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/clubs"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param version
 * @param optional nil or *ClubsApiGet_1Opts - Optional Parameters:
     * @param "Offset" (optional.Int32) -
     * @param "Limit" (optional.Int32) -
     * @param "IsCancellationRequested" (optional.Bool) -
     * @param "CanBeCanceled" (optional.Bool) -
...
func (a *ClubsApiService) Get_1(ctx context.Context, version string, localVarOptionals *ClubsApiGet_1Opts) ([]ClubInfo, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v{version}/clubs"
